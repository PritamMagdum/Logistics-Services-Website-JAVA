			...
			<div class="cardBox">
				<div class="card">
					<div style="width:150px">
						...
						<div class="cardName"><h3>Categories</h3></div>
					</div>
					<div class="iconBox">
				...
				<div class="boxmainbody" data-toggle="modal" data-target="#exampleModal">
					<h1 style="text-align: center" class="cardName">Add Categories</h1>
      ...
      <div class="modal-body">
        <form action="ServiceOperationServlet" method="post">
       	...
       	<input type="hidden" name="operation" value="addcategory">
        	...
        	<div class="form-group">
        		<textarea class="form-control" name="categoryDescription" placeholder="Enter Category Description" required="required"></textarea>
        	</div>
