      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="TrackSearch.jsp">Track</a></li>
           <li><a href="UserContact.jsp" class="active">Contact</a></li>
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
		...
		<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15139.097618168247!2d73.8240175!3d18.4485493!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2953b7b878c49%3A0x81b2448774346377!2sZeal%20Education%20Society!5e0!3m2!1sen!2sin!4v1676578275613!5m2!1sen!2sin" style="border:0; width: 100%; height: 340px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> 
       </div><!-- End Google Maps -->
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <form action="ContactOperationServlet" method="post">
            <input type="hidden" name="operation" value="addContact">
              ...
              <div></div>
              <div Style="margin-top:10px;" class="text-center"><button class="btn" type="submit">Send Message</button></div>
            </form>
