...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top" style="padding: 15px 50px">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="NewUserHome.jsp" class="active">Home</a></li>
          ...
          <li><a class="get-a-quote" href="UserGetQuote.jsp" style="margin-right:-54px">Get In Touch</a></li>
  ...
  <section class="home">
    ...
    <div class="content">
      <h1>Thakar<br><span>Logistics</span></h1>
      <p>Thakar Logistics is typed with one of the most popular PW GATES Logistics. </p>
      <a href="#">Read More</a>
    </div>
    <div class="content">
      <h1>Thakar<br><span>Logistics</span></h1>
      <p>Thakar Logistics is typed with Rider Ever Better Logistics. </p>
      <a href="#">Read More</a>
    </div>
    <div class="content">
      <h1>Thakar<br><span>Logistics</span></h1>
      <p>Thakar Logistics is providing 24/7 hours services. </p>
      <a href="#">Read More</a>
    </div>
    <div class="content">
      <h1>Thakar<br><span>Logistics</span></h1>
      <p>Thakar Logistics is providing automative, cloths, lab equipments delivery services. </p>
      <a href="#">Read More</a>
    </div>
    <div class="media-icons">
      ...
      <a href="https://mobile.twitter.com/abhikarpe744497"><i class="fab fa-twitter"></i></a>
    </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
            ...
            <div>
              <h4 class="title">Product Loading</h4>
              <p class="description">Loaders typically work in warehouses, where they prepare outgoing shipments and receive incoming goods by loading and unloading trucks.</p>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            ...
            <div>
              <h4 class="title">Truck Delivery	</h4>
              <p class="description">It is the role responsible for delivering various items to different addresses as assigned</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
              <h4 class="title">Truck Loading</h4>
              <p class="description">The primary duty of a truck loader is loading shipments on tractor trailers and taking shipments off of trucks upon arrival.</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start order-lg-last order-first">
            ...
            <a href="https://youtu.be/MKdm5CqnURI?t=2" class="glightbox play-btn"></a>
          </div>
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>About Us</h3>
             <p>
We assist clients with every phase of a project including planning and consultation, heavy lift operations, sourcing, consolidation and distribution, warehousing,
 full and part charters, insurance, export packing and customs clearance and documentation</p>
            <ul>
              <li data-aos="fade-up" data-aos-delay="100">
                <i class="bi bi-diagram-3"></i>
                <div>
                  <h5>Multiple Delivery</h5>
