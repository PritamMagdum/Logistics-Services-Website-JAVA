    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="HomeAbout.jsp" >About</a></li>
          ...
          <li><a class="get-a-quote" href="GetQuote.jsp">Get In Touch</a></li>
        </ul>
      </nav><!-- .navbar -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>About Us</h3>
            <p>
We assist clients with every phase of a project including planning and consultation, heavy lift operations, sourcing, 
consolidation and distribution, warehousing, full and part charters, insurance, export packing and customs clearance and documentation</p>
            <ul>
